# Renaud's presentations based on reveal.js
This repos is a collection of presentations based on [reveal.js](https://travis-ci.org/hakimel/reveal.js). Instead of creating a single repo for each and every presentations, this repository will act as a collection of such presentations with the following organisation:
- *template* branch that will hold all modifications applicable for every presentations. All presentations will be forked from the *template* branch.
- One branch per presentation (forked from the *template* branch)
- When a presentation needs to be published online, use the *gh-pages* branch and override it everytime.
